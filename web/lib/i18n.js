...
const ZH = {
  ...
  retriedWith: '第一次输出预算不够（多半是带思考的模型），已自动按 {n} tokens 重试成功，并把设置里的「最大输出」改成了 {n}。', retriedMeta: '预算加到 {n} 后重试成功',
  ...
  notesPh: '例如：上午跟客户对了需求，下午把导出功能写完了，还剩分页没做。', notesSaving: '保存中…',
  notesSave: '保存手记',
  notesHow: '写完点「保存手记」，它就成了下面时间板上的一个泡泡，输入框会清空，可以接着写第二条。不要了就点那个泡泡里的「删掉这条手记」。',
  notesCount: '今天已经写了 {n} 条，都在下面的时间板上。',
  noteDelete: '删掉这条手记', noteDeleteConfirm: '确定删掉这条手记吗？它和它配的图都会一起删掉，日记里也不会再有。', noteDeleted: '已删掉这条手记',
...
const EN = {
  ...
  retriedWith: 'The first attempt ran out of output budget (likely a reasoning model); retried with {n} tokens, succeeded, and saved {n} as "Max output" in Settings.', retriedMeta: 'succeeded after raising the budget to {n}',
  ...
  notesPh: 'e.g. Aligned requirements with the client in the morning, finished the export feature in the afternoon, pagination still pending.', notesSaving: 'Saving…',
  notesSave: 'Save note',
  notesHow: 'Press "Save note" when you finish one: it becomes a bubble on the board below, the box clears, and you can write the next one. To get rid of one, use "Delete this note" inside its bubble.',
  notesCount: '{n} note(s) today — all on the board below.',
  noteDelete: 'Delete this note', noteDeleteConfirm: 'Delete this note? It and its images will be removed for good, and it will no longer be part of your diary.', noteDeleted: 'Note deleted',
